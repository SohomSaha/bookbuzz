        ...
        <div className="order-2 md:order-1 w-full md:w-1/2 md:mt-32 mt-12">
          <div className=" space-y-12 ">
            ...
            <p className="text-l pr-2">
              ...
              voluptate dolorem iste quam neque soluta voluptatem? Enim
              molestias totam, maiores beatae autem laborum quo ipsa facilis!
              Perspiciatis molestias quibusdam velit!
            </p>
